...
//add news
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addnews' && $_SESSION['key']=='admin') {

$desc = $_POST['desc'];
$id=uniqid();
$q3=mysqli_query($con,"INSERT INTO news VALUES  ('$id','$desc', NOW())");
...
//remove news
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmnews' && $_SESSION['key']=='admin') {
$eid=@$_GET['eid'];
$result = mysqli_query($con,"SELECT * FROM news WHERE id='$eid' ") or die('Error');
while($row = mysqli_fetch_array($result)) {
$r1 = mysqli_query($con,"DELETE FROM news WHERE id='$eid'") or die('Error');
}
...
//add topic
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addimp' && $_SESSION['key']=='admin') {

$desc = $_POST['desc'];
$id=uniqid();
$q3=mysqli_query($con,"INSERT INTO important VALUES  ('$id','$desc', NOW())");
...
//remove topics
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmimp' && $_SESSION['key']=='admin') {
$eid=@$_GET['eid'];
$result = mysqli_query($con,"SELECT * FROM important WHERE id='$eid' ") or die('Error');
while($row = mysqli_fetch_array($result)) {
$r1 = mysqli_query($con,"DELETE FROM important WHERE id='$eid'") or die('Error');
}
